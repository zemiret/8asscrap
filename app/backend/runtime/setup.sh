...
EOF
	...
	echo "Generating env_app_local. REMEMBER TO FILL THIS ONE IN!"

cat <<EOF > env_app_local
...
EOF
	...
	echo Generating env_app_docker. REMEMBER TO FILL THIS ONE IN!

cat <<EOF > env_app_docker
APP_DEBUG=<false or true>
APP_DB_HOST=mongo
APP_DB_USER=root
APP_DB_PASSWORD=$MONGO_INITDB_ROOT_PASSWORD
